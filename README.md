...
The 'organization name' is shown under "CLOUD FOUNDRY ORG", and in general it's the same as your email.
The 'space name' is shown under "CLOUD FOUNDRY SPACE", and is usually called 'dev'. 
